...
<head>
    ...
    <title>Book Cover - SAHANA G</title>
    <style>
    ...
    <div class="book-cover">
        ...
        <div class="footer">
            <div class="footer-text">
                ...
                <p class="author-name">MS.SAHANA G</p>
            </div>
            <div class="author-photo">
                <img src="image.png" alt="SAHANA G"> 
            </div>
        </div>
    </div>
...
## OUTPUT:
<img width="656" height="835" alt="image" src="https://github.com/user-attachments/assets/f12581d3-8e37-429b-b3a7-9315f1da836c" />
